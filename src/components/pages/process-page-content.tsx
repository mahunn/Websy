      ...
      <section className="section-pad relative z-10 bg-transparent">
        <div className="container-page max-w-3xl">
          {m.process.items.map((step, index) => (
            ...
            >
              <span className="absolute -left-[1.1rem] flex h-9 w-9 items-center justify-center rounded-full border border-white/60 bg-white/70 text-[11px] font-semibold text-brand backdrop-blur-md shadow-sm">
