...
export function ServiceCard({ slug, icon }: ServiceCardProps) {
  ...
  return (
    ...
    >
      <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand/10 text-brand border border-brand/12 shadow-sm transition-all duration-300 group-hover:bg-brand group-hover:text-white">
        {icons[icon]}
      </div>
